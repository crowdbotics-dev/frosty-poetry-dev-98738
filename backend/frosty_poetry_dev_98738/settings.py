"""
Django settings for frosty_poetry_dev_98738 project.
...
ROOT_URLCONF = 'frosty_poetry_dev_98738.urls'
...
WSGI_APPLICATION = 'frosty_poetry_dev_98738.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_poetry_dev_98738 API",
    "DESCRIPTION": "API documentation for frosty_poetry_dev_98738 App",
    "VERSION": "v1",
}
