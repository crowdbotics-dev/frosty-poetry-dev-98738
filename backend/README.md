...
## Project Structure
    ...
    ├── frosty_poetry_dev_98738  # Django project configurations
...
1. Clone this repo and `cd frosty_poetry_dev_98738`
...
2. Clone this repo and `cd frosty_poetry_dev_98738`
